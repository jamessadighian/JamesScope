...
class SwabianHistogram(Measurement):
    ...
    def run(self):
        ...
        '''
        this is the part without synchronizer, lets see if it works
        '''
        # self.counter = Counter(self.tt_hw.tagger, channels=[2, 3], binwidth=self.settings['counter_bin_width'], n_values=self.settings['counter_n_values'])
