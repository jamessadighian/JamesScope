...
try:
    ...
    try:
        ...
        assert version in ['2.7', '3.5', '3.6', '3.7', '3.8', '3.9', '3.10'], 'This Python version is not supported by the Time Tagger software suite.'
        raise
...
def createTimeTaggerNetwork(*args, **kwargs):
...
def __getTimeTaggerServerInfo(*args, **kwargs):
...
class TimeTaggerBase(object):
    ...
    def setSoftwareClock(self, input_channel, input_frequency=10e6, averaging_periods=1000, wait_until_locked=True):
    ...
    def getSoftwareClockState(self):
...
class TimeTaggerNetwork(TimeTaggerBase):
    ...
    def setNormalization(self, channel, state):
        ...
        return _TimeTagger.TimeTaggerNetwork_setNormalization(self, channel, state)
    ...
    def getSensorData(self):
        ...
        return _TimeTagger.TimeTaggerNetwork_getSensorData(self)
    ...
    def getLicenseInfo(self):
        ...
        return _TimeTagger.TimeTaggerNetwork_getLicenseInfo(self)
...
class TimeTagger(TimeTaggerBase):
    ...
    def isChannelRegistered(self, chan):
