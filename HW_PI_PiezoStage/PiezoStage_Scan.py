...
class PiezoStage_Scan(Measurement):
    ...
    def setup(self):
        ...
        self.ui_filename = sibling_path(__file__, "stage_scan2.ui")
        ...
        '''
        new shit here - james 20220909
        '''
        
        self.settings.New('mychannel', dtype=int, choices=[1, 2, 3], initial=2)
    ...
    def setup_figure(self):
        ...
        '''
        new shit james 20220909
        '''
        
        self.settings.mychannel.connect_to_widget(self.ui.APD_comboBox)
